	...
	<div class="flex flex-1 overflow-hidden">
		...
		<main class="flex-1 p-6 overflow-hidden">
			...
			<div class="grid grid-cols-4 gap-6 mb-6">
				...
				<div
					class="bg-cyan-400 text-white p-6 rounded-xl text-center shadow-md">
				...
				<div
					class="bg-orange-500 text-white p-6 rounded-xl text-center shadow-md">
				...
				<div
					class="bg-sky-800 text-white p-6 rounded-xl text-center shadow-md">
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div id="alertCard"
					...
					<!-- ⭐ UPDATED -->
					<div class="px-4 py-3 border-b text-lg font-bold">Alerts</div>

					<div
						class="px-4 py-3 flex-1 overflow-y-auto text-sm space-y-3 scroll-lock">
						<%
					...
					<div class="px-4 py-3 border-b flex justify-between items-center">
						...
						<form method="get">
							<select name="period" onchange="this.form.submit()"
								...
								<option value="today"
									<%="today".equals(period) ? "selected" : ""%>>Today</option>
								<option value="week"
									<%="week".equals(period) ? "selected" : ""%>>Week</option>
								<option value="month"
									<%="month".equals(period) ? "selected" : ""%>>Month</option>
							</select>
						</form>
					</div>
