...
/* ===============================
   AUTO SEARCH + AJAX (DO NOT REMOVE)
   =============================== */
                        ...
                        "<div class='inline-flex gap-4 justify-center'>" +
                            "<div class='relative group flex flex-col items-center'>" +
                                ...
                                "<span class='absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block " +
                                      "bg-black text-white text-[10px] py-1 px-2 rounded shadow-lg whitespace-nowrap z-50'>View</span>" +
                            "</div>" +
                        "</div>" +
                    "</td>" +
                "</tr>"
...
/* ===============================
   PAGINATION — EXACT PRODUCT MASTER
   =============================== */
let rowsPerPage = 10;
let currentPage = 1;
...
function paginateTable() {
    ...
    prev.className = prev.disabled
        ? "px-3 py-1 rounded-full text-gray-400 cursor-not-allowed"
    ...
    function addPage(p) {
        ...
        btn.className = p === currentPage
            ...
            : "px-3 py-1 rounded-full hover:bg-white";
        btn.onclick = () => { currentPage = p; paginateTable(); };
